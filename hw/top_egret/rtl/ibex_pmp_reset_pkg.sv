...
package ibex_pmp_reset_pkg;
  import ibex_pkg::*;
  import top_egret_pkg::TOP_EGRET_MMIO_BASE_ADDR;
  import top_egret_pkg::TOP_EGRET_MMIO_SIZE_BYTES;
  ...
  localparam logic [33:0] PmpAddrRst[16] = '{
    ...
    34'h00000000, // rgn 8
    34'h00000000, // rgn 9
    TOP_EGRET_MMIO_BASE_ADDR,                              // rgn: 10
    TOP_EGRET_MMIO_BASE_ADDR + TOP_EGRET_MMIO_SIZE_BYTES,  // rgn: 11
    34'h00000000, // rgn 12
    34'h00000000, // rgn 13
    34'h00000000, // rgn 14
    34'h00000000  // rgn 15

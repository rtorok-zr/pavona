...
module otp_ctrl_cov_bind;
  ...
  `PART_MUBI_COV(rot_owner_auth_slot2, otp_ctrl_part_pkg::RotOwnerAuthSlot2Idx)
  `PART_MUBI_COV(rot_owner_auth_slot3, otp_ctrl_part_pkg::RotOwnerAuthSlot3Idx)
  `PART_MUBI_COV(rot_owner_auth_slot0_state, otp_ctrl_part_pkg::RotOwnerAuthSlot0StateIdx)
  `PART_MUBI_COV(rot_owner_auth_slot1_state, otp_ctrl_part_pkg::RotOwnerAuthSlot1StateIdx)
  `PART_MUBI_COV(rot_owner_auth_slot2_state, otp_ctrl_part_pkg::RotOwnerAuthSlot2StateIdx)
  `PART_MUBI_COV(rot_owner_auth_slot3_state, otp_ctrl_part_pkg::RotOwnerAuthSlot3StateIdx)
  ...
  `DAI_MUBI_COV(rot_owner_auth_slot2, otp_ctrl_part_pkg::RotOwnerAuthSlot2Idx)
  `DAI_MUBI_COV(rot_owner_auth_slot3, otp_ctrl_part_pkg::RotOwnerAuthSlot3Idx)
  `DAI_MUBI_COV(rot_owner_auth_slot0_state, otp_ctrl_part_pkg::RotOwnerAuthSlot0StateIdx)
  `DAI_MUBI_COV(rot_owner_auth_slot1_state, otp_ctrl_part_pkg::RotOwnerAuthSlot1StateIdx)
  `DAI_MUBI_COV(rot_owner_auth_slot2_state, otp_ctrl_part_pkg::RotOwnerAuthSlot2StateIdx)
  `DAI_MUBI_COV(rot_owner_auth_slot3_state, otp_ctrl_part_pkg::RotOwnerAuthSlot3StateIdx)
